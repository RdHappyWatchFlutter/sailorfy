...
//
//     final popularTrainingListModel = popularTrainingListModelFromJson(jsonString);

import 'dart:convert';

PopularTrainingListModel popularTrainingListModelFromJson(String str) => PopularTrainingListModel.fromJson(json.decode(str));

String popularTrainingListModelToJson(PopularTrainingListModel data) => json.encode(data.toJson());

class PopularTrainingListModel {
  List<PopularTrainingList> data;

  PopularTrainingListModel({
    required this.data,
  });

  factory PopularTrainingListModel.fromJson(Map<String, dynamic> json) => PopularTrainingListModel(
    data: List<PopularTrainingList>.from(json["data"].map((x) => PopularTrainingList.fromJson(x))),
  );
...
class PopularTrainingList {
  ...
  factory PopularTrainingList.fromJson(Map<String, dynamic> json) => PopularTrainingList(
